...
function addiCodes(catid, title, desc, url, code, s5,s6,s7,status,img){
	...
	PremiumPressDo('../wp-content/themes/classifiedstheme/PPT/ajax/actions.php?action=icodes&type='+s7+'&catid='+catid+'&title='+title+'&desc='+desc+'&url='+url+'&code='+code+'&exp='+s5+'&mer='+s6+'&st='+status+'&img='+img,'ShopperPressAlert');
}
...
function UserActionForm(val,val1,act,div){
	...
	PremiumPressDo('../wp-content/themes/classifiedstheme/PPT/ajax/actions.php?action=UserActionForm&act='+act+'&data='+val+'&data1='+val1,div);
}
