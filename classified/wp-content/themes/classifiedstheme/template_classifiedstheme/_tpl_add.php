...
<?php if(isset($data) && get_option('pak_enabled') ==1 ){ ?>
 ...
 <?php } ?>       
        ...
        <p class="f_half left"> 
            ...
            <input type="text" name="form[tags]"  class="short" tabindex="5" id="tags1" value="<?php if(isset($_POST['action']) && !isset($data) ){ echo $_POST['form']['tags']; }elseif(isset($data)){ echo $tags; } ?>" /><br />
        ...
        <p class="f_half left"> 
            <label for="name"><?php echo SPEC($GLOBALS['_LANG']['_tpl_add19']) ?></label><br />
 ...
 <?php if($PACKAGE_OPTIONS[$_POST['packageID']]['a4'] ==1 || get_option('pak_enabled') !=1 ){ ?>
        <p class="f_half left"> 
            ...
            <input type="text" name="form[map_location]"  class="short" tabindex="9" value="<?php if(isset($_POST['action']) && !isset($data) ){ echo $_POST['form']['map_location']; }elseif(isset($data)){ echo get_post_meta($_GET['eid'], 'map_location', true); } ?>" /><br />
        ...
        <?php } ?> 
            ...
            <p class="f_half left"> 
            <label for="name"><?php echo SPEC($GLOBALS['_LANG']['_tpl_add47']) ?></label><br />
            <span style="font-size:18px;"><?php echo $GLOBALS['premiumpress']['currency_symbol']; ?></span><input type="text" name="form[price]"  tabindex="10" class="short" style="width:50px;"  value="<?php if(isset($_POST['action']) && !isset($data) ){ echo $_POST['form']['price']; }elseif(isset($data)){ echo $data['price']; } ?>" /><br />
            <small><?php echo SPEC($GLOBALS['_LANG']['_tpl_add48']) ?></small> 
        </p>
...
<div class="full clearfix border_t box"> 
	...
	'price'			=> SPEC($GLOBALS['_LANG']['_tpl_add47']),
