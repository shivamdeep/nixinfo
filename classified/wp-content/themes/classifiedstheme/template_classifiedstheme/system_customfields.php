...
add_meta_box( 'premiumpress_customfields_88', __( 'Message Data', 'sp' ), 'premiumpress_message', 'message_type', 'normal', 'high' );

	}
}

/* ============================ PREMIUM PRESS CUSTOM FIELD FUNCTION ======================== */
 function premiumpress_message(){
	...
	echo '<table width="100%"  border="0"><tr width="50%"><td valign="top">';
		...
		echo '<label style="font-size:14px; line-height:30px;">' . __("<b>TO User</b> (example: imagename.jpg or http://../imagename.jpg)", 'sp' ) . '</label><br />';
		echo '<input type="text" name="field[username]" id="g_image" value="'.get_post_meta($post->ID, 'username', true).'" style="font-size:14px;padding:5px; width:95%; background:#e7fff3;"/><br /><br />';
 	
	echo '</td><td width="50%" valign="top">';

	echo '<label style="font-size:14px; line-height:30px;">' . __("<b>FROM User</b>  ", 'sp' ) . '</label><br />';
	echo '<input type="text" name="field[from]" value="'.get_post_meta($post->ID, 'from', true).'" style="font-size:14px;padding:5px; width:95%; height:60px; background:#e7fff3;" /><br /><br />';
...
<h3 style="background:none;font-size:18px;margin-left:0px;padding-left:0px;"><img src="../wp-content/themes/classifiedstheme/images/premiumpress/h-ico/open alt.png" align="middle"> Options</h3> <a class="premiumpress_button" href="javascript:void(0);" onclick="PPHelpMe(\'addlisting\')">Help Me</a>							 
<ul>
