...
<h3><img src="<?php echo $GLOBALS['template_url']; ?>/images/premiumpress/h-ico/new%20doc.png" align="middle"> Submit Page Setup</h3>							 
<ul>
	...
	<tr class="mainrow">
	  <td class="titledesc">Enable Packages</td>
		<td class="forminp">
			...
			<input type="checkbox" name="pak_enabled" value="1" <?php if(get_option("pak_enabled") ==1){ echo "checked"; } ?>><br />
			<small>Enable this to allow custom pricing on your submit listing page.</small>
...
<br />
			<small>This is the text that appears on the sidebar whilst users add new listings. You can include HTML.</small>
...
<br />
			<small>This is the text that appears at the bottom of the package selection page. You can include HTML.</small>
...
<center><img src="<?php echo $GLOBALS['template_url']; ?>/template_classifiedstheme/images/help1/a26.png"></center>
...
<td  style="background:#fff;">
	<tr class="mainrow">
	  <td class="titledesc">Enable Package</td>
		<td class="forminp">
			<input type="checkbox" name="package[<?php echo $i; ?>][enable]" value="1" <?php if(isset($packdata[$i]['enable']) && $packdata[$i]['enable'] ==1){ echo "checked"; } ?>><br />
			<small>Check this box to enable this package to be displayed.</small>
		</td>
	</tr>
	...
	<tr class="mainrow" style="background:#fff;">
	  <td class="titledesc">Package Name</td>
		<td class="forminp">
			<input type="text" name="package[<?php echo $i; ?>][name]" style="width:300px;" value="<?php echo $packdata[$i]['name']; ?>"><br />
			<small>Give this package a name which will be displayed on the submission page.</small>
		</td>
	</tr>
</td></tr>
<tr><td>
	...
	<tr class="mainrow" style="background:#fff;">
	  <td class="titledesc">Package Price</td>
		<td class="forminp">
            ...
            <br />
			<small>Check the box if you wish this to be a recurring subscription. The package will renew automatically after the days you specify in the field below expire. (Days Before Expiry). <b>Works with Paypal only.</b></small>
	...
	<tr class="mainrow"  style="background:#fff;">
	  <td class="titledesc">Days Before Expiry</td>
		<td class="forminp">
			<input type="text" name="package[<?php echo $i; ?>][expire]" style="width:50px;" value="<?php echo $packdata[$i]['expire']; ?>"><br />
			<small>Give a numeric value for amount of time the listing will display before its automatically removed. Leave blank for never.</small>
		</td>
	</tr>
...
<table width="100%"  border="0">
  <tr>
    ...
    <td><input type="checkbox" name="package[<?php echo $i; ?>][a2]" value="1" <?php if(isset($packdata[$i]['a2']) && $packdata[$i]['a2'] ==1){ echo "checked"; } ?>> <strong>Multi-Categories</strong><br /><p>This will allow the user to submit their listing to upto 3 categories.</p></td>
  </tr>
  <tr>
